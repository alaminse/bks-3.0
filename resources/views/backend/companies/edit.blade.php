...
@section('content')
    ...
    <div class="card shadow border-0">
        <div class="card-body">
            <form action="{{ route('backend.companies.update', $company->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="total_value" class="form-control" id="total_value" value="{{ old('total_value', $company->total_value) }}" step="0.01" min="0" required>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="share_price" class="form-label">Price Per Share ($) <span class="text-danger">*</span></label>
                        <input type="number" name="share_price" class="form-control" id="share_price" value="{{ old('share_price', $company->share_price) }}" step="0.01" min="0" required>
                    </div>
