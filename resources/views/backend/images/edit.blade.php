...
@section('title') Edit Featured Image @endsection

@section('content')
<div class="container-fluid">
    @include('includes.header', [
        'pageTitle' => 'Edit Featured Image',
            ...
            <div class="card shadow border-0">
                <div class="card-body">
                    ...
                    <form id="image-edit-form"
                          action="{{ route('backend.images.update', $image) }}"
                          method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Brief description about this banner...">{{ old('description', $image->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status"
                                        ...
                                        required>
                                    <option value="active" {{ old('status', $image->status) === 'active' ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="inactive" {{ old('status', $image->status) === 'inactive' ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                </select>
                                @error('status')
