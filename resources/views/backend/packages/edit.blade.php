            ...
            <div class="col mx-auto">
                <div class="card shadow border-0">
                    <div class="card-body">
                        ...
                        <form action="{{ route('backend.packages.update', $package->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" step="0.01" name="daily_earning" class="form-control"
                                        value="{{ old('daily_earning', $package->daily_earning) }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" step="0.01" name="per_task_earning" class="form-control"
                                        value="{{ old('per_task_earning', $package->per_task_earning) }}">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="features" rows="3" class="form-control" placeholder="Enter features (one per line or comma-separated)">{{ old('features', $package->features) }}</textarea>
                            </div>
