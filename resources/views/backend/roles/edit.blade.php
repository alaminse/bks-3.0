    ...
    <div class="col">
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0"><i class="fa-solid fa-pen-to-square"></i> Edit Role Information</h5>
            </div>
            <div class="card-body">
                @if (count($errors) > 0)
                ...
                <form method="POST" action="{{ route('backend.roles.update', $role->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="form-text text-muted mt-2 d-block">
                            <i class="fa-solid fa-circle-info"></i> Update the permissions that users with this role should have.
                        </small>
                    </div>
