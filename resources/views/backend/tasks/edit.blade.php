            ...
            <div class="card shadow border-0">
                <div class="card-body">
                    ...
                    <form id="task-edit-form"
                          action="{{ route('backend.tasks.update', $task) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" rows="3"
                                      ...
                                      placeholder="Describe what the user needs to do...">{{ old('description', $task->description) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="task_type" id="task_type"
                                    ...
                                    <option value="youtube"  {{ old('task_type', $task->task_type) === 'youtube'  ? 'selected' : '' }}>YouTube</option>
                                    <option value="visit"    {{ old('task_type', $task->task_type) === 'visit'    ? 'selected' : '' }}>Social Media / Visit</option>
                                    <option value="custom"   {{ old('task_type', $task->task_type) === 'custom'   ? 'selected' : '' }}>Custom</option>
                                    <option value="adsterra" {{ old('task_type', $task->task_type) === 'adsterra' ? 'selected' : '' }}>🔥 Adsterra Ad</option>
                                </select>
                        ...
                        <div class="mb-3 d-none" id="adsterra-fields">
                            <div class="alert alert-warning d-flex align-items-start gap-2 mb-3">
                                ...
                                <div>
                                    ...
                                    <small>Paste your Adsterra ad script/code below. Users will see this ad in a modal overlay. After the skip delay, a "Skip & Claim Reward" button appears.</small>
                                </div>
                            </div>
                            ...
                            <textarea name="adsterra_ad_code" id="adsterra_ad_code" rows="6"
                                      ...
                                      placeholder="Paste your Adsterra &lt;script&gt; or banner code here...">{{ old('adsterra_ad_code', $task->adsterra_ad_code) }}</textarea>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="number" name="ad_skip_delay"
                                       ...
                                       value="{{ old('ad_skip_delay', $task->ad_skip_delay ?? 5) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3" id="duration-field">
                                ...
                                <input type="number" name="required_duration"
                                       ...
                                       value="{{ old('required_duration', $task->required_duration ?? 0) }}"
                                       min="0" placeholder="0">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-primary"
                                    onclick="confirmFormSubmit('task-edit-form', {
                                        title: 'Update Task?',
