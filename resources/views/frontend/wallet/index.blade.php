...
@section('content')
    ...
    <div class="page-header-bar">
        ...
        <div class="page-header-actions">
            <a href="{{ route('wallet.deposit') }}" class="cy-hbtn primary">
                <i class="bi bi-plus-circle-fill"></i> Deposit
            </a>
            <a href="{{ route('withdraw.index') }}" class="cy-hbtn outline">
        ...
        <div class="wlt-left">
                    ...
                    <div class="wlt-mini-stats">
                        <div class="wlt-mini-item">
                            ...
                            <div>
                                ...
                                <div class="wlt-mini-value" style="color:var(--green);">
                                    ${{ number_format($wallet->available_balance ?? 0, 2) }}</div>
                            </div>
                        </div>
                        <div class="wlt-mini-item">
                            ...
                            <div>
                                ...
                                <div class="wlt-mini-value" style="color:var(--gold);">
                                    ${{ number_format($wallet->locked_balance ?? 0, 2) }}</div>
                            </div>
                        </div>
                        <div class="wlt-mini-item">
                            ...
                            <div>
                                ...
                                <div class="wlt-mini-value" style="color:var(--accent);">
                                    ${{ number_format($totalEarned ?? 0, 2) }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="wlt-qa">
                <div class="wlt-qa-head">
                    <span class="wlt-qa-title">Quick Actions</span>
                </div>
                <div class="wlt-qa-grid">
                    <a href="{{ route('wallet.deposit') }}" class="wlt-qa-item highlight">
                        <div class="wlt-qa-icon"><i class="bi bi-plus-circle-fill" style="color:var(--green);"></i></div>
                        Deposit
                    </a>
                    <a href="{{ route('withdraw.index') }}" class="wlt-qa-item">
                        <div class="wlt-qa-icon"><i class="bi bi-send-fill" style="color:var(--red);"></i></div>
                        Withdraw
                    </a>
                    <a href="{{ route('packages.index') }}" class="wlt-qa-item">
                        <div class="wlt-qa-icon"><i class="bi bi-box-seam-fill" style="color:var(--blue);"></i></div>
                        Packages
                    </a>
                    <a href="{{ route('wallet.transactions') }}" class="wlt-qa-item">
                        <div class="wlt-qa-icon"><i class="bi bi-clock-history" style="color:var(--gold);"></i></div>
                        History
                    </a>
                    <a href="{{ route('tasks.index') }}" class="wlt-qa-item">
                        <div class="wlt-qa-icon"><i class="bi bi-lightning-charge-fill" style="color:var(--accent);"></i>
                        </div>
                        Tasks
                    </a>
                </div>
            ...
            <div class="wlt-txn">
                <div class="wlt-txn-header">
                    <span class="wlt-txn-htitle"><i class="bi bi-arrow-left-right" style="color:var(--accent);"></i>
                        ...
                        <tbody>
                            @forelse($transactions as $txn)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="wt-desc">{{ Str::limit($txn->description ?? '—', 45) }}</div>
                                        @if ($txn->reference_id)
                                            <div class="wt-ref">{{ $txn->reference_type }} #{{ $txn->reference_id }}
                                            </div>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <span class="wt-status {{ $sc }}">
                                            <i
                                                class="bi {{ $sc === 'pending' ? 'bi-hourglass-split' : ($sc === 'rejected' || $sc === 'failed' ? 'bi-x-circle-fill' : 'bi-check-circle-fill') }}"></i>
                                            {{ ucfirst($sc) }}
                                        </span>
                                    </td>
                                </tr>
        ...
        <div class="wlt-right">
            ...
            <div class="wlt-card-widget">
                <div class="wlt-cw-head">
                    <span class="wlt-cw-title"><i class="bi bi-credit-card" style="color:var(--accent);"></i> My
                        Card</span>
                </div>
                <div class="wlt-cw-body">
                    <div class="cyber-card">
                        <div class="cc-inner">
                            <div class="cc-top">
                                <div class="cc-brand">TopTrade</div>
                            ...
                            <div class="cc-bottom">
                                ...
                                <div>
                                    ...
                                    <div class="cc-avail-val">${{ number_format($wallet->available_balance ?? 0, 2) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cc-details">
                        <div class="cc-detail-row">
                            ...
                            <span class="cc-dv">••• {{ str_pad(auth()->id(), 4, '0', STR_PAD_LEFT) }}</span>
                        </div>
                        <div class="cc-detail-row">
                            <span class="cc-dk">Status</span>
                            <span class="cc-dv" style="color:var(--green);">● Active</span>
                        </div>
                        <div class="cc-detail-row">
                            <span class="cc-dk">Locked</span>
                            <span class="cc-dv"
                                style="color:var(--gold);">${{ number_format($wallet->locked_balance ?? 0, 2) }}</span>
                        </div>
                        <div class="cc-detail-row">
                            <span class="cc-dk">Currency</span>
                            <span class="cc-dv">USDT</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                @forelse($transactions->take(5) as $txn)
                    @php
                        ...
                        $icons = [
                            ...
                            'withdraw' => 'bi-arrow-up-circle-fill',
                    ...
                    <div class="txn-row">
                        <div style="display:flex;align-items:center;gap:10px;">
                            <div class="txn-ico {{ $dir === 'credit' ? 'cr' : 'db' }}">
                                <i class="bi {{ $icon }}"></i>
                            </div>
                            <div>
                        ...
                        <div class="txn-amt {{ $dir === 'credit' ? 'cr' : 'db' }}">
                            {{ $dir === 'credit' ? '+' : '−' }}${{ number_format($txn->amount, 2) }}
                        </div>
                    </div>
                @empty
                    <div class="wlt-empty" style="padding:24px;">
                        <i class="bi bi-inbox"></i>
                        <p>No activity yet</p>
                    </div>
                @endforelse
...
@push('scripts')
    ...
    <script>
        (function() {
            ...
            g1.addColorStop(0, accent + '40');
            g1.addColorStop(1, accent + '00');
