    ...
    <div class="txh-left">
        ...
        <div class="txh-filter">
            ...
            <div class="txh-active-filters">
                ...
                <span class="txh-pill">{{ ucfirst(request('direction')) }} <a href="{{ request()->fullUrlWithQuery(['direction'=>null]) }}">×</a></span>
                @endif
        ...
        <div class="txh-widget">
            ...
            <div class="txh-bk-body">
                @php
                    ...
                    $breakdown = [
                        ['label'=>'Deposits',    'color'=>'var(--green)', 'type'=>'deposit'],
                        ['label'=>'Withdrawals', 'color'=>'var(--red)',   'type'=>'withdraw'],
                        ['label'=>'Tasks',       'color'=>'var(--accent)','type'=>'task'],
                        ['label'=>'Packages',    'color'=>'var(--blue)',  'type'=>'package'],
                        ['label'=>'Referrals',   'color'=>'#818cf8',      'type'=>'referral'],
                    ];
                @endphp
                ...
                <div class="txh-bk-row">
                    <div class="txh-bk-top">
                        <div class="txh-bk-name">
                            <span class="txh-bk-dot" style="background:{{ $bk['color'] }};"></span>
                            {{ $bk['label'] }}
                        </div>
                        <div class="txh-bk-count">{{ $cnt }}</div>
                    </div>
                    <div class="txh-bk-bar-bg">
                        <div class="txh-bk-bar-fill" style="width:{{ $pct }}%;background:{{ $bk['color'] }};"></div>
                    </div>
                </div>
                @endforeach
            </div>
